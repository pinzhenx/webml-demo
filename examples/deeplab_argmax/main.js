const deeplab257dilatedargmax = {
  modelName: 'DeepLab 257 Atrous Argmax',
...
const deeplab513dilatedargmax = {
  modelName: 'DeepLab 513 Atrous Argmax',
...
function main(camera) {
  ...
  const availableModels = [
    deeplab257dilatedargmax,
    deeplab513dilatedargmax,
  ];
