...
const objectDetectionModels = [{
  ...
  modelSize: '44.9MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/object_detection/model/tiny_yolov2_coco.tflite',
  ...
  modelSize: '63.4MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/object_detection/model/tiny_yolov2_voc.tflite',
