...
const imageClassificationModels = [{
  ...
  inputSize: [224, 224, 3],
  outputSize: 1001,
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/mobilenet_v1_1.0_224.tflite',
  ...
  inputSize: [224, 224, 3],
  outputSize: 1001,
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/mobilenet_v2_1.0_224.tflite',
  labelsFile: '../image_classification/model/labels1001.txt',
  preOptions: {
    mean: [127.5, 127.5, 127.5],
    std: [127.5, 127.5, 127.5],
  ...
  inputSize: [299, 299, 3],
  outputSize: 1001,
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/inception_v3.tflite',
  labelsFile: '../image_classification/model/labels1001.txt',
  preOptions: {
    mean: [127.5, 127.5, 127.5],
    std: [127.5, 127.5, 127.5],
...
},
{
  ...
  inputSize: [299, 299, 3],
  outputSize: 1001,
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/inception_v4.tflite',
  labelsFile: '../image_classification/model/labels1001.txt',
  preOptions: {
    mean: [127.5, 127.5, 127.5],
    std: [127.5, 127.5, 127.5],
...
},
{
  ...
  inputSize: [224, 224, 3],
  outputSize: 1001,
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/squeezenet.tflite',
  labelsFile: '../image_classification/model/labels1001.txt',
  preOptions: {
    mean: [127.5, 127.5, 127.5],
    std: [127.5, 127.5, 127.5],
  ...
  inputSize: [299, 299, 3],
  outputSize: 1001,
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/inception_resnet_v2.tflite',
  labelsFile: '../image_classification/model/labels1001.txt',
  preOptions: {
    mean: [127.5, 127.5, 127.5],
    std: [127.5, 127.5, 127.5],
  ...
  modelSize: '5.0MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/squeezenet1.1.onnx',
  ...
  modelSize: '14.2MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/mobilenetv2-1.0.onnx',
  labelsFile: '../image_classification/model/labels1000.txt',
  inputSize: [224, 224, 3],
  outputSize: 1000,
  preOptions: {
  ...
  modelSize: '102.6MB',
  modelFile: 'https://brucedai.github.io/nt/examples/image_classification/model/resnet50v1.onnx',
  labelsFile: '../image_classification/model/labels1000.txt',
  inputSize: [224, 224, 3],
  outputSize: 1000,
  preOptions: {
  ...
  modelSize: '102.4MB',
  modelFile: 'https://brucedai.github.io/nt/examples/image_classification/model/resnet50v2.onnx ',
  labelsFile: '../image_classification/model/labels1000.txt',
  inputSize: [224, 224, 3],
  outputSize: 1000,
  preOptions: {
  ...
  modelSize: '45.0MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/inceptionv2.onnx',
  ...
  modelSize: '32.7MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/image_classification/model/densenet121.onnx',
  labelsFile: '../image_classification/model/labels1000.txt',
  inputSize: [224, 224, 3],
  outputSize: 1000,
  preOptions: {
...
const objectDetectionModels = [{
  ...
  modelSize: '27.3MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/object_detection/model/ssd_mobilenet_v1.tflite',
  ...
  modelSize: '67.3MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/object_detection/model/ssd_mobilenet_v2.tflite',
  labelsFile: '../object_detection/model/coco_classes.txt',
  type: 'SSD',
  box_size: 4,
  num_classes: 91,
  ...
  modelSize: '17.9MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/object_detection/model/ssdlite_mobilenet_v2.tflite',
  labelsFile: '../object_detection/model/coco_classes.txt',
  type: 'SSD',
  box_size: 4,
  num_classes: 91,
  ...
  modelSize: '44.9MB',
  modelFile: 'https://brucedai.github.io/nt/examples/object_detection/model/tiny_yolov2_coco.tflite',
  ...
  modelSize: '63.4MB',
  modelFile: 'https://brucedai.github.io/nt/examples/object_detection/model/tiny_yolov2_voc.tflite',
...
const humanPoseEstimationModels = [{
  ...
  modelSize: '13.3MB',
  modelFile: 'https://huningxin.github.io/webml-examples/examples/skeleton_detection/model/mobilenet_v1_101',
  inputSize: [513, 513, 3],
  preOptions: {
    mean: [127.5, 127.5, 127.5],
    std: [127.5, 127.5, 127.5],
...
const semanticSegmentationModels = [{
    ...
    modelSize: '9.5MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_224.tflite',
    ...
    modelSize: '8.4MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_224_dilated.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [224, 224, 3],
    outputSize: [224, 224, 21],
    preOptions: {
    ...
    modelSize: '9.5MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_257.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [257, 257, 3],
    ...
    modelSize: '8.4MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_257_dilated.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [257, 257, 3],
    outputSize: [257, 257, 21],
    preOptions: {
    ...
    modelSize: '9.5MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_321.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [321, 321, 3],
    ...
    modelSize: '8.4MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_321_dilated.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [321, 321, 3],
    outputSize: [321, 321, 21],
    preOptions: {
    ...
    modelSize: '9.5MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_513.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [513, 513, 3],
    ...
    modelSize: '8.4MB',
    modelFile: 'https://huningxin.github.io/webml-examples/examples/semantic_segmentation/model/deeplab_mobilenetv2_513_dilated.tflite',
    labelsFile: '../semantic_segmentation/model/labels.txt',
    inputSize: [513, 513, 3],
    outputSize: [513, 513, 21],
    preOptions: {
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', function() {
    navigator.serviceWorker.register('/webml-demo/sw.js').then(function(registration) {
